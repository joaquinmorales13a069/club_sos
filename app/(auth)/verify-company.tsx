...
export default function VerifyCompanyScreen() {
    ...
    const validateCompanyCode = async () => {
        ...
        try {
            ...
            if (!empresa) {
                setErrorMessage(
                    "No se encontró ninguna empresa con ese código.",
                );
                return;
            }
            ...
            <SafeAreaView className="flex-1 bg-sos-white dark:bg-[#101822]">
                ...
                <View className="flex-1 px-4">
                    ...
                    <Text className="pb-6 font-sans text-base leading-normal text-sos-gray dark:text-gray-400">
                        Ingresa el código único proporcionado por tu empleador
                        para acceder a tus beneficios.
                    </Text>
                    ...
                    {empresaEncontrada && (
                        <CompanyFoundCard
                            ...
                            isVerified={
                                empresaEncontrada.estado.toLowerCase() ===
                                "verificada"
                            }
                        />
                    )}
